...
import { WandIcon, DocumentIcon, DownloadIcon, BrainIcon } from './icons';
        ...
        <div className="flex flex-col h-full bg-gray-800">
            ...
            <div className="flex-1 flex overflow-hidden">
                <textarea
                    ...
                    className="w-full h-full p-6 bg-gray-800 text-gray-200 resize-none focus:outline-none text-lg leading-relaxed"
                    placeholder="Start writing your note..."
                />
                <div className="w-1/3 border-l border-gray-700 p-4 flex flex-col space-y-4 bg-gray-800/50">
